...
export default function BarcodeCompiler() {
    ...
    const [targetSheetId, setTargetSheetId] = useState('1H0BaAKcBAOcQWkQBRfD7MCJ_kYcr2N6ou3p6wCE6t8w'); // if blank it will use the script's default sheet
    const [targetTabName, setTargetTabName] = useState('Raw Match Scouting');

    const exportToSheets = async () => { // {"n":"Name","e":"mitvc","m":1,"p":"Red 1","t":1711,"sa":4,"cla":1,"bta":2,"st":10,"btt":1,"dtt":10,"pn":10,"ctt":6,"clt":1,"rt":"Dumper","dt":"Swerve","ob":1,"ut":1,"ds":2,"df":2,"rs":1,"sy":2,"ic":2,"sc":2,"c":"none","ts":1777893255120}
